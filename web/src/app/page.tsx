...
const FEATURES = [
  {
    ...
    title: "算出の考え方を公開しています",
    body: "月額賃料から管理費と修繕積立金を差し引いた実質的な収入をもとに、エリアと築年数ごとの基準と照らし合わせて相場価格を算出しています。根拠のない数値や、あいまいな推定で結果を出すことはありません。",
  },
  {
  ...
  },
  {
    ...
    title: "入力内容はご本人だけが閲覧できます",
    body: "物件情報と診断結果は、ご登録いただいたアカウントに紐づけて保管し、他の利用者から閲覧されることはありません。",
  },
  {
